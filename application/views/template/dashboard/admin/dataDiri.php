...
<div class="mb-1 row align-items-center border-bottom">
   <label class="col-sm-2 col-form-label">No. KTP / NIK / Paspor</label>
   <div class="col-sm-4 col-form-label ">
...
<div class="mb-1 row align-items-center border-bottom">
   <label class="col-sm-2 col-form-label">Kualifikasi Pendidikan</label>
   <div class="col-sm-4 col-form-label ">
...
<div class="mb-1 row align-items-center border-bottom">
   <label class="col-sm-2 col-form-label">Nama Institusi / Perusahaan</label>
   <div class="col-sm-4 col-form-label ">
      <div><?= $asesi[0]->namaPerusahaan?></div>
   </div>
</div>
<div class="mb-1 row align-items-center border-bottom">
   <label class="col-sm-2 col-form-label">Jabatan</label>
   <div class="col-sm-4 col-form-label ">
      <div><?= $asesi[0]->jabatan?></div>
   </div>
</div>
<div class="mb-1 row align-items-center border-bottom">
   <label class="col-sm-2 col-form-label">Alamat Kantor</label>
   <div class="col-sm-4 col-form-label ">
      <div><?= $asesi[0]->alamatPerusahaan?></div>
   </div>
</div>
<div class="mb-1 row align-items-center border-bottom">
   <label class="col-sm-2 col-form-label">Kode Pos Kantor</label>
   <div class="col-sm-4 col-form-label ">
      <div><?= $asesi[0]->kodPosPerusahaan?></div>
   </div>
</div>
<div class="mb-1 row align-items-center border-bottom">
   <label class="col-sm-2 col-form-label">No. Telp / Fax / Email</label>
   <div class="col-sm-4 col-form-label ">
      <div><?= $asesi[0]->noTelpPerusahaan?></div>
   </div>
</div>